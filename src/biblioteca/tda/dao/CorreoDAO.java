...
//creamos metodo insertar 
       /**
        * Método para insertar nueva Correo en la base de datos
        * @param correo Objeto Correo que se insertará en la base de datos
        */
     ...
     * @param id
     * @return  Correo con los datos buscados en la base de datos
     * @throws SQLException 
     */
